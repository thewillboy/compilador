...
print("3 - Selecione a opção default (qualquer tecla) do menu para testar o código no compilador")
print("\n\n")
...
if __name__ == '__main__':
  ...
  env = {}
  while True:
    opcao = input('prog_made_by_dummies ([0] read_file/arg_file / [default] input_text) > ')
    if opcao == '0':
      x = 0
